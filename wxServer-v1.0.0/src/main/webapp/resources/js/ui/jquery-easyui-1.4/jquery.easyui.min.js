...
var frame=$('iframe', tab);		//caojm 2015/5/29 iframe 内存泄露
if(frame.length>0){
...
//$(this).addClass("datagrid-header-over");		//caojm 去除鼠标掉悬浮表头的样式
}).bind("mouseleave.datagrid",function(){
//$(this).removeClass("datagrid-header-over");	//caojm 去除鼠标掉悬浮表头的样式
...
if(_615.total!=data.total && data.total > 0){	//data.total为从数据库查询出来的总数_615.total为pageSize*pageNumber，例如数据库中没有任何数据即data.total=0，请求加载第一页时_615.total=1*20=20
	_614.pagination("refresh",{total:data.total});// caojm:解决当查询数据=0时会重新刷新
